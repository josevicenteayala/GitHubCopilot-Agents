...
> [`../.github/prompts/*.prompt.md`](../.github/prompts/), and
> [`../.github/chatmodes/*.chatmode.md`](../.github/chatmodes/). To turn a template in this folder
...
surfaces that Copilot auto-discovers, all of which live in `.github/`:

| Surface | File location | Activated by | Scope |
|---------|---------------|--------------|-------|
| **Repository instructions** | [`../.github/copilot-instructions.md`](../.github/copilot-instructions.md) | *Automatic* — every Copilot request in the repo | Everyone, everywhere |
| **Prompt file** | [`../.github/prompts/*.prompt.md`](../.github/prompts/) | Typing `/` in Copilot Chat and picking it | One invocation |
| **Custom chat mode** | [`../.github/chatmodes/*.chatmode.md`](../.github/chatmodes/) | The chat mode picker in VS Code | A whole conversation |

A fourth surface — the **Copilot coding agent** (cloud) — is documented in
[`coding-agent-setup.md`](coding-agent-setup.md).

Each file in *this* directory (`agents/*.md`) is a **design doc** that maps
...
[`../.github/prompts/`](../.github/prompts/) and [`../.github/chatmodes/`](../.github/chatmodes/) — you can
...
|-------|------------|------------------|------|----------|
| 💻 Code Implementation | [code-implementation-agent.md](code-implementation-agent.md) | [`../.github/prompts/code-implementation.prompt.md`](../.github/prompts/code-implementation.prompt.md) | Senior Java Developer | Completing TODO methods, implementing business logic |
| 🔍 PR Review | [pr-review-agent.md](pr-review-agent.md) | [`../.github/prompts/pr-review.prompt.md`](../.github/prompts/pr-review.prompt.md) | Senior Code Reviewer | Reviewing pull requests for bugs, quality, security |
| 📚 Documentation | [documentation-agent.md](documentation-agent.md) | [`../.github/prompts/documentation.prompt.md`](../.github/prompts/documentation.prompt.md) | Technical Writer | JavaDoc, OpenAPI annotations, README sections |
| 🧪 Testing | [testing-agent.md](testing-agent.md) | [`../.github/prompts/testing.prompt.md`](../.github/prompts/testing.prompt.md) | QA Engineer | JUnit 5 + Mockito unit tests, coverage improvement |
| 🏛️ Design & Architecture | [design-architecture-agent.md](design-architecture-agent.md) | [`../.github/prompts/design-architecture.prompt.md`](../.github/prompts/design-architecture.prompt.md) | Software Architect | Architecture reviews, pattern recommendations |
| ♻️ Refactoring | [refactoring-agent.md](refactoring-agent.md) | [`../.github/prompts/refactoring.prompt.md`](../.github/prompts/refactoring.prompt.md) | Code Quality Specialist | Eliminating code smells, applying design patterns |

The two reference chat modes are
[`senior-java-dev.chatmode.md`](../.github/chatmodes/senior-java-dev.chatmode.md) (paired
with the Code Implementation and Refactoring agents) and
[`code-reviewer.chatmode.md`](../.github/chatmodes/code-reviewer.chatmode.md) (paired with
the PR Review agent).
...
- [Repository instructions](../.github/copilot-instructions.md) — shared project rules
- [Prompt files](../.github/prompts/) — reference prompt implementations
- [Chat modes](../.github/chatmodes/) — reference chat-mode implementations
